...
<section id="article">
    <div class="container">
        <div class="page-container">
            <article class="card">
                <img src="<c:url value="/img/stalker-2-art-1.jpg"/>"  alt="article">
                <h1 class='l-heading'><c:out value="${requestScope.mainNews[0].title}" /></h1>
                <div class="meta">
                    <small>
                        <i class="fas fa-user"></i><c:out value="${requestScope.mainNews[0].author}" />
                    </small>
                    <div class="category category-ent">Игры и развлечения</div>
                </div>
                <p><c:out value="${requestScope.mainNews[0].content}" /></p>
            </article>
