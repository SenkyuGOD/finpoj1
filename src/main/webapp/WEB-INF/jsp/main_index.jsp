...
<head>
    ...
    <title>Новости | alpha test</title>
</head>
<body>
<nav id="main-nav">
    <div class="container">
        ...
        <ul>
            <li><a href="MyController?command=go_to_index_page" class="current">Главная</a></li>
    ...
    <div class="container">
        <div class="showcase-container">
            <div class="showcase-content">
                ...
                <p>Превью "Бавария" - "Реал": где смотреть, составы, новости</p>
                <a href="MyController?command=go_to_news_page" class="btn btn-primary">Читать</a>
            </div>
        </div>
    </div>
</header>
...
<section id="home-articles" class="py-2">
    <div class="container">
        ...
        <div class="articles-container">
            <article class="card">
                <img src="<c:url value="/img/articles/ent1.jpg"/>" alt="photo">
                <div>
                    <div class="category category-ent">
                        Entertainment
                    </div>
                    <h3>
                        <a href="MyController?command=go_to_news_page">Lorem ipsum dolor sit amet.</a>
                    </h3>
            ...
            <article class="card">
                ...
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Laborum expedita quam quibusdam ipsum nemo maiores. Cum ipsa amet quaerat sunt.</p>
                <img src="<c:url value="/img/articles/sports1.jpg"/>" alt="photo">
            </article>

            <article class="card">
                <img src="<c:url value="/img/articles/tech2.jpg"/>" alt="photo">
                <div class="category category-tech">
                    Technology
                </div>
                <h3>
            ...
            <article class="card">
                ...
                <img src="<c:url value="/img/articles/ent2.jpg"/>" alt="photo">
            </article>
        </div>
    </div>
</section>
