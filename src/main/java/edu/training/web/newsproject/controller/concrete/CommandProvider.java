...
public class CommandProvider {
    ...
    public CommandProvider() {
        ...
        /*commands.put(CommandName.CREATE_NEWS, new );
        commands.put(CommandName.GET_NEWS, new);
        commands.put(CommandName.DELETE_NEWS, new);
        commands.put(CommandName.UPDATE_NEWS, new);
